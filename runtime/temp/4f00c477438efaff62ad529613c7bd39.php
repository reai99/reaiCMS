<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"E:\phpEnv\www\localhost/application/admin\view\article\addlabel.html";i:1578843050;s:66:"E:\phpEnv\www\localhost\application\admin\view\public\include.html";i:1577537275;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
<meta charset="utf-8">
        ...
        <div class="reai-row reai-col-space8">
			<div class="reai-col-sm12">
				<div class="reai-panel">
					<div class="reai-panel-title">标签管理</div>
	  ...
	  <div class="reai-table-change">
		<div class="reai-row reai-form">
           <div  class="reai-form-item">
				<label class="reai-form-label">labelID</label>
				<div class="reai-input-block">
					<input type="text" name="labelid" class="reai-input">
				</div>
			</div>
			<div  class="reai-form-item">
				<label class="reai-form-label">标签名称</label>
			<div class="reai-input-block">
				<input type="text" name="labelname" class="reai-input">
			</div>
		    </div>
