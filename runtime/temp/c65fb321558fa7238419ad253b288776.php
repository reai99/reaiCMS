<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"E:\phpEnv\www\localhost/application/admin\view\article\editart.html";i:1579013991;s:66:"E:\phpEnv\www\localhost\application\admin\view\public\include.html";i:1577537275;s:66:"E:\phpEnv\www\localhost\application\admin\view\public\editart.html";i:1580713626;s:66:"E:\phpEnv\www\localhost\application\admin\view\public\ueditor.html";i:1577463912;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
<script type="text/javascript">
       var ue = UE.getEditor('editor');
		...
		<script type="text/javascript">
	ue.ready(function(){
		<?php if(isset($artlist)): ?> ue.setContent(`<?php echo $artlist['content']; ?>`)<?php endif; ?>
	})
				...
				form.submit('.reai-form-submit',function(data){
					ue.ready(function(){
						if(ue.hasContents()){
							...
							data.id=parseInt(<?php echo $artlist['id']; ?>);
							reai.ajax({
