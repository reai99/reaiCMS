<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"E:\phpEnv\www\localhost/application/admin\view\index\createpage.html";i:1580480296;s:66:"E:\phpEnv\www\localhost\application\admin\view\public\include.html";i:1577537275;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
			...
			<div class="reai-col-sm12">
				<div class="reai-panel">
					...
					<div class="reai-table-deal">
						<button type="button" class="reai-btn reai-btn-md table-event-edit">添加路径</button>
